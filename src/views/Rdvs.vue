<template>
  <section
    class="bg-image"
    style="
      background-image: url('https://img.freepik.com/free-vector/seamless-repeating-pattern-with-cosmetics-set-bottles-tubes-jars-skin-care-with-face-hair-body-cream-fashion-style-postcard-banner-template-wrapping-paper-vector_509073-264.jpg');
  ...
  methods: {
    async getAll() {
      const response = await fetch(
        "http://localhost/brief-6/back-end/api/rdv/afficherRdv/" + this.ref
      );
